...
function Card1({auth}) {
    return (
        <div>
 <div className="row p-3 card1Row">
            <div className="col-12 col-sm-12 col-lg-4 col-md-4 mt-5">
                ...
                <p className="card1Header"><span className="text-light"><GoClock className="clockIcon"/></span>5 days left to enroll</p>
            ...
            <div className="col-12 col-sm-12 col-lg-4 col-md-4 mt-5">
                ...
                <p className="card1Header"><span className="text-light"><GoClock className="clockIcon"/></span>Starts in 15 days</p>
                <div className="cardDetails p-3">
            ...
            <div className="col-12 col-sm-12 col-lg-4 col-md-4 mt-5">
                <div className="card1Column">
                <img src={teaching} alt="" className="img-fluid card1Image" />
                <p className="card1Header"><span className="text-light"><GoClock className="clockIcon"/></span>Batch Closes in 2 days</p>
                <div className="cardDetails p-3">
